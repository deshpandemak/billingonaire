...
def calculate_case_fee(case_data: Dict) -> Dict:
    ...
    try:
        ...
        if latest_status != "analysed":
            return {"result": "*ADJOURNED*", "fee": 1250, "order_link": None, "order_category": None}
        ...
        if (
            ...
            return {"result": "WP DISPOSED OF", "fee": 2500, "order_link": order_link, "order_category": order_category}

        # Check for heard & adjourned (middle fee)
        elif "HEARD" in order_category and "ADJOURNED" in order_category:
            return {"result": "HEARD & ADJN.", "fee": 1875, "order_link": order_link, "order_category": order_category}
        ...
        # Check for simple adjournment (lowest fee)
            ...
            if "paucity of time" in order_text or "due to paucity" in order_text:
                return {"result": "ADJOURNED", "fee": 1250, "order_link": order_link, "order_category": order_category}
            else:
                return {"result": "ADJOURNED", "fee": 1250, "order_link": order_link, "order_category": order_category}
