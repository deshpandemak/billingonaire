...
def test_scenario_1():
    ...
    data = [
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1001', 'case_year': '2025', 'serial_number': '', 'lawyer': 'A'},
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1002', 'case_year': '2025', 'serial_number': '', 'lawyer': 'B'},
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1003', 'case_year': '2025', 'serial_number': '', 'lawyer': 'C'},
        {'file_name': 'test.pdf', 'case_type': 'CP', 'case_no': '1004', 'case_year': '2025', 'serial_number': '', 'lawyer': 'D'},
    ]
...
def test_scenario_2():
    ...
    data = [
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1001', 'case_year': '2025', 'serial_number': '', 'lawyer': 'First lawyer'},
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1001', 'case_year': '2025', 'serial_number': '', 'lawyer': 'Second lawyer'},  # DUPLICATE case
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1002', 'case_year': '2025', 'serial_number': '', 'lawyer': 'Different case'},
    ]
...
def test_scenario_3():
    ...
    data = [
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1001', 'case_year': '2025', 'serial_number': '1', 'lawyer': 'A'},
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1002', 'case_year': '2025', 'serial_number': '', 'lawyer': 'B'},
        {'file_name': 'test.pdf', 'case_type': 'WP', 'case_no': '1003', 'case_year': '2025', 'serial_number': '3', 'lawyer': 'C'},
    ]
...
def test_deduplication(df, scenario_name):
    ...
    for i, row in df.iterrows():
        print(f"  {i+1}. {row['case_type']}/{row['case_no']}/{row['case_year']} serial:'{row['serial_number']}' lawyer:{row['lawyer']}")
